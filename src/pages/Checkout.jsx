  ...
  return (
    <div className="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3 py-6 my-6 bg-white px-8">
          <form>
            ...
            <div className=" border-b border-gray-900/10 pb-6">
              ...
              <ul  className="divide-y divide-gray-200 border-solid border-t border-b border-l border-r border-slate-200 ">
      {address.map((addres) => (
        <li key={addres.name} className="flex justify-between gap-x-6 px-5 py-5 ">
          <div className="flex gap-x-4 ">
          <input
                        id="cash"
                        name="address"
                        type="radio"
                        className="h-4 w-4 border-gray-300 text-indigo-600 mt-1 focus:ring-indigo-600"
                      />
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
              ...
              <div className="mt-1 flex items-center gap-x-1.5">
                ...
                <p className="text-xs leading-5 text-gray-500">{addres.city}</p>
              </div>
        ...
        <div className="lg:col-span-2 my-6 px-3  bg-white h-min">
